...
this is the instructor's version, with checking on for EACH problem! 
...
Gameplan: do some of the harder 2pt ones in class on wednesday, to save time from prepping additional practice problems in carnap. 

7 problems have a full proof checker (with green check), including the last one. The other 5 do syntax only
