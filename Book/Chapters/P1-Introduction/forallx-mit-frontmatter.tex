...
\thispagestyle{empty}
{\Huge\forallx} \hfill {\LARGE \texttt{(MIT 24.241 Fall 2024)}} %modify \forallx command in style file under TITLE AND VERSION DATA 
...
{\sf Rewritten for MIT from Ichikawa and Mangus' version of {\tt forall\script{x}}\ which included sections from the Calgary Remix by Magnus, Button, Loftis, Trueman, Thomas-Bolduc, and Zach.}
...
{\sf
	MIT 24.241 Fall 2024 edition \\%version 2.2 [\bookversion]\\
...
\vfill
{
\copyright\ \ifthenelse{\year=2024}{\number\year}{2024--\number\year} Benjamin Brast-McKie. Some rights reserved.
}
