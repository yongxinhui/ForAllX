...
\begin{quote} 
  ...
  % Assume $\Gamma \vDash \metaA$ and $\Gamma \eifeq \Gamma'$.
...
\begin{Lthm} \label{lemma:FOL-live}
  If $\Gamma \vDash \metaA$ and $\Gamma \subseteq \Gamma'$, then $\Gamma' \vDash \metaA$.
\end{Lthm}
% \vspace{-.3in}
...
% Whereas \textbf{\ref{lemma:FOL-smweak}} says that logical consequence is preserved upon adding premises, \textbf{\ref{lemma:FOL-live}} makes an important observation about how undischarged assumptions are inherited by live lines.
...
\begin{quote} 
  ...
  Since $\metaA_k$ is live at line $n+1$, we know by \textbf{\ref{lemma:FOL-live}} that $\Gamma_k\subseteq \Gamma_{n+1}$, and so $\Gamma_{n+1} \vDash \metaA_{k}$ by \bref{lemma:FOL-smweak}.
...
\begin{quote} 
  ...
  % By hypothesis, $\Gamma_i\vDash \metaA_i$ and $\Gamma_j\vDash \metaA_j$ where $\Gamma_i,\Gamma_j\subseteq \Gamma_{n+1}$ by \textbf{\ref{lemma:FOL-live}}.
  % Thus $\Gamma_{n+1} \vDash \metaA_i$ and $\Gamma_{n+1} \vDash \metaA_j$ by \textbf{\ref{lemma:FOL-smweak}}.
...
%   It follows that $\Gamma_j\subseteq\Gamma_{n+1}\cup\set{\metaA_i}$, and so $\Gamma_{n+1}\cup\set{\metaA_i} \vDash \metaA_j$ by \textbf{\ref{lemma:FOL-smweak}}.
