...
Given $\D_{\Delta}$, we will specify referents and extensions for the constants and predicates of our language in such that the resulting model $\M_\Delta$ satisfies all and only the sentences that belong to $\Delta$.
