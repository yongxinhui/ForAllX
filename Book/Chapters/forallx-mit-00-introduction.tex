...
Since not all arguments take such explicit forms as the argument above, part of what we will be concerned with is \textsc{regimenting} arguments in English by translating them into a formal language.
