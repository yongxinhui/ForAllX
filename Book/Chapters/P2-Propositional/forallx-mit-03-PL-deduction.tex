...
In addition to being familiar, reasoning in this way helps to illustrate the logical connections between various claims in a manner that is compelling \textit{on its own terms}.
...
Having introduced all of the rules of PL, we may now move to discuss some of the mistakes that are easy to make when first learning to write proofs in PL.
We will begin by reviewing some of the common mistakes that can occur when using subproofs.
