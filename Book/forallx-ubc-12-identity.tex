...
If we were attempting to understand what `$=$' means without drawing on any previous understanding, the certainly we should agree that the semantic clauses given above get us nowhere.
