...
In order to characterise the abstract forms themselves, we will use the variables.
...
Sentential variables allow us to talk about the sentences of a language, but they're not themselves sentences themselves.
