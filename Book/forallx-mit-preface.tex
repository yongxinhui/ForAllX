...
I inherited a version of Ichikawa's {\tt forall\script{x}} from Josh Hunt who worked to bring the text closer to \textit{The Logic Book} by Bergmann, Moor, and Nelson for the purposes of teaching Logic I at MIT.
...
These include the following primary changes:
  \begin{itemize}
    ...
    \item Change to a modern notation that is easy to write on the board. % for greater congruence between the notation used in class and what is used in the textbook.
