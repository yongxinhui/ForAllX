...
We will use `\enot.'
Now we can regiment `Not $H$' to `$\enot H$'.
...
This is called a \define{biconditional}, because it entails the two conditionals $S\eif T$ and $T \eif S$. We will use `\eiff' to represent the biconditional.
...
Since the meaningful expressions of SL are the wffs and since every wff of SL is either true or false, we may now define the \define{sentences} of SL to be the wffs of SL.
