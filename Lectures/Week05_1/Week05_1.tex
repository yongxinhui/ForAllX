...
\title{\textbf{PL Completeness}} % Subtitle
...
%
% \begin{itemize}
%   \item[\bf C13.2] If $\MetaG\vDash\metaA$, then there is a finite subset $\Lambda\subseteq\MetaG$ where $\Lambda\vDash\metaA$.
%   \item[\bf C13.3] $\MetaG$ is satisfiable if every finite subset $\Lambda\subseteq\MetaG$ is satisfiable.
% \end{itemize}
